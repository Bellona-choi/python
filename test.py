...
#for x in range(0, 50):
 #   xTrainData.append(random.randint(0,20))
#for y in range(0,50):
#    yTrainData.append(random.randint(4000,30000))
xTrainData = [random.randint(0,10) for value in range(0,50)]
yTrainData = [random.randint(10000,20000) for value in range(0,50)]
zTrainData = [random.randint(0,20) for value in range(0,50)]#for x in xTrainData:
    # y 데이터 생성
